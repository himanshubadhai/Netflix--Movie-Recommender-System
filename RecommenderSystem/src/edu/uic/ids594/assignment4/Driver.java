...
implements Tool{
	...
	public int run(String[] args)
		...
		JobConf config1 = new JobConf(getConf(), Driver.class);
		config1.setJobName("Job1");
		...
		config1.setJarByClass(Driver.class);
		...
		FileInputFormat.addInputPath(config1, new Path("/Users/himansubadhai/Documents/input/assignment4/cf/u.data"));
		FileOutputFormat.setOutputPath(config1, new Path("/Users/himansubadhai/Documents/input/assignment4/cf-out"));
		JobClient.runJob(config1);

		// creating configuration object for job-2
		JobConf config2 = new JobConf(getConf(), Driver.class);
		config2.setJobName("Job2");
		...
		config2.setMapOutputValueClass(Text.class);

		// setting classes for job-2
		config2.setJarByClass(Driver.class);
		config2.setMapperClass(Mapper2.class);
		config2.setReducerClass(Reducer2.class);

		//setting input and output file path for job-2
		FileInputFormat.addInputPath(config2, new Path("/Users/himansubadhai/Documents/input/assignment4/cf-out"));
		FileOutputFormat.setOutputPath(config2, new Path("/Users/himansubadhai/Documents/input/assignment4/output"));
